...
export const info = {
    firstName: "Tirth",
    lastName: "Patel",
    initials: "Tirth P.", // the example uses first and last, but feel free to use three or more if you like.
    ...
    bio: "Hello! I'm Tirth. \n I'm in my third year of Mechanical Engineering at Western University doing a dual degree with computer science. I chose to do a dual degree because I have had a strong passion for robotics and mechanical systems. Also I realise the future is heading to a place where mechanical systems will intertwine with software. Aside from studying, I have done several clubs and projects, such as First Robotics Competition, Model Theme Park Ride, and Western Baja, to get hands on experiences. These experiences also helped develop my skills on 3D modeling, designing, time management, and collarbrating. Starting May 2023, I want to do a Mechanical Engineering Co-op where I can get industrial experience by working on engineering projects. \nEnjoy the rest of my portfolio and thank you for your time.",
    skills:
    {
        proficientWith: ['Java', 'Python', 'Arduino', 'SolidWorks', 'Autodesk Inventor', 'Onshape', 'MATLAB', "Microsoft Office Suite"],
        exposedTo: ['Github', 'AI']
    }
    ,
    hobbies: [
    ...
    portfolio: [ // This is where your portfolio projects will be detailed
        {
            ...
            text: "Baja is an Off-Road Racing Competition, where teams build and race a dune buggy. I have been a strong and consistent member for Baja for 3 years and have led sub-team for 2 years. During my time at Baja, I have designed and manufactured durable parts and assemblies using Design for Manufacturing (DFM), Design for Assembly (DFA). Being a sub-team lead, I completed projects on a efficient and timely manner to ensure the car is ready for competition. Overall, my experiences with Western Baja have been amazing fun and has taught me a lot.",
            buttonLabel: "",
            buttonIcon: "",
            link: "",
            image: Project5
        ...
        },
        {
            ...
            text: "In a team of 2, we create a model of a revolutionary new ride we called Dragon Drop. The ride has 4 degrees of freedom, 3 controlled by motors and 1 freewheeling. This project integrated speaker, vex motors, servos, LEDs, and custom Arduino code. The project was one of the best projects in class and was presented in the school`s Sci-Tech open house.",
            buttonLabel: "",
            buttonIcon: "",
            link: "",
            image: Project2
