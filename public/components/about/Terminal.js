...
function Terminal(props) {
   ...
   return (
      <Box component={'section'} className={classNames(Style.terminal, Style.shadowed)}
         width={{ xs: '8S0%', md: '70%' }} borderRadius={'0.5rem'} mb={'4rem'}>
         <Box sx={{ backgroundColor: '#ededd6' }} fontSize={'1.5rem'} fontFamily={'arial'}>
            ...
            <Box component={'mid'} display={'flex'} flexDirection={{ xs: 'column', md: 'row' }}>
               ...
               <Box width={{ md: '90%' }} sx={{ border: 2, borderColor: "#000000" }}>
                  {text}
               </Box>
